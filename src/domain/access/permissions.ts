...
export const resourceFeatures: Readonly<Record<ResourceId, FeatureId | null>> =
  {
    ...
    floor_stock_configuration: "inventory",
...
export const roleDefaults: RoleDefaults = Object.freeze({
  ...
  department_user: {
    dashboard: ["read"],
    new_request: ["read", "create", "edit", "delete"],
  },
  master: {
    dashboard: ["read"],
    announcements: ["read"],
    zebra_labels: ["read"],
    new_request: ["read", "approve", "manage"],
    inventory_item: ["read", "manage"],
    inventory_location: ["read", "manage"],
    inventory_lot: ["read", "manage"],
    floor_stock_configuration: ["read", "manage"],
  ...
  pharmacy_supervisor: {
    ...
    inventory_lot: ["read"],
    floor_stock_configuration: ["read"],
    inventory_stock: ["read", "receive", "issue", "adjust", "transfer"],
    inventory_balance: ["read"],
    inventory_transaction: ["read"],
  },
